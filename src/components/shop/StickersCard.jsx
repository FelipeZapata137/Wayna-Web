...
export default function StickersCard({ products, onCotizar }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-6">
          <h3 className="text-xl font-bold mb-1 text-gray-900">Stickers Personalizados</h3>
          ...
          <div className="flex items-center justify-center mb-4">
            <button
              ...
              className="text-sm text-gray-600 underline hover:text-wayna-green transition-colors flex items-center gap-1"
            >
              <Info size={16} />
              + Costo de Entrega (Ver)
            </button>
          </div>
